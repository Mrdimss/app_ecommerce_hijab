...
Route::get('/details/{hijab:slug}', [FrontController::class, 'details'])->name('front.details');

Route::get('/order/begin/{hijab:slug}', [OrderController::class, 'saveOrder'])->name('front.save_order');
